...
helm install jupyterhub/binderhub --version=$VERSION  --name=$CLUSTER_NAME --namespace=$CLUSTER_NAME -f config/binder_config.yml -f secrets/binder_secret.yml

# Get the hub ip address
kubectl --namespace=$CLUSTER_NAME get svc proxy-public

# Upgrade the deployment
helm upgrade $CLUSTER_NAME jupyterhub/binderhub --version=$VERSION -f config/binder_config.yml -f secrets/binder_secret.yml
